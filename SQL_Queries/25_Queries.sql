...
-- ==============================================================================
-- Query 26: Top 10 Products
-- WHAT IT DOES: Identifies the 10 most sold products based on total quantity.
-- WHY USE TOP AND ORDER BY: To rank products and limit the output to the best sellers.
-- ==============================================================================
SELECT TOP 10 
    P.ProductName, 
...
-- ==============================================================================
-- Query 27: Sales by Category
-- WHAT IT DOES: Calculates the total revenue generated by each product category.
-- WHY MULTIPLE JOINS: Need to link Categories to Products, then to Order_Details for revenue.
-- ==============================================================================
SELECT 
    C.CategoryName, 
...
-- ==============================================================================
-- Query 28:Monthly Sales
-- WHAT IT DOES: Calculates the total revenue generated in each month and year.
-- WHY EXTRACT DATES: To track revenue growth over time for time-series analysis.
-- ==============================================================================
SELECT 
...
-- ==============================================================================
-- Query 29:  Top Customers
-- WHAT IT DOES: Finds the top 10 customers based on their total lifetime spending.
-- WHY GROUP BY: Aggregates all orders for a single customer to find their total value.
-- ==============================================================================
SELECT TOP 10 
    C.FirstName + ' ' + C.LastName AS CustomerName, 
...
-- WHAT IT DOES: Lists products that exist in inventory but have never been sold.
-- WHY LEFT JOIN: Retrieves all products, filtering for those with no matching OrderID.
-- ==============================================================================
SELECT 
    P.ProductName, 
    P.StockQuantity
...
-- ==============================================================================
-- Query 31: Supplier Sales
-- WHAT IT DOES: Calculates how much revenue was generated from each supplier's products.
-- WHY INNER JOIN: Connects Suppliers to Products and then to actual sales data.
-- ==============================================================================
SELECT 
    S.CompanyName, 
    SUM(OD.LineTotal) AS TotalSalesGenerated
FROM Suppliers S
INNER JOIN Products P ON S.SupplierID = P.SupplierID
INNER JOIN Order_Details OD ON P.ProductID = OD.ProductID
GROUP BY S.CompanyName
...
-- ==============================================================================
-- Query 32: Inventory Status
-- WHAT IT DOES: Categorizes the current stock levels to identify restocking needs.
-- WHY CASE STATEMENT: Dynamically labels products as Out of Stock, Low Stock, or In Stock.
-- ==============================================================================
SELECT 
    ProductName, 
    StockQuantity,
...
-- ==============================================================================
-- Query 33:  Order Status Summary
-- WHAT IT DOES: Counts the number of orders in each status (e.g., Pending, Delivered).
-- WHY GROUP BY: Summarizes operational performance by grouping identical statuses.
-- ==============================================================================
SELECT 
    OrderStatus, 
